param(
    ...
    [string]$ProfileDir = "runtime/data/chrome_profile_1688_fresh_safe",
...
$builder = Join-Path $PSScriptRoot "build_1688_workflow.py"
$closeoutHelper = Join-Path $PSScriptRoot "closeout_marketplace_run.py"
