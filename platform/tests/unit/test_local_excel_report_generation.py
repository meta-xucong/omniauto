...
TASK_DESCRIPTION = (
    r"读取 D:\AI\AI_RPA\runtime\data\reports\1688_single_rocking_chair_5\report_data.json，"
    r"用WPS表格整理成一个直观、方便观看的Excel报表，"
    r"并保存到 D:\AI\AI_RPA\runtime\data\reports\1688_single_rocking_chair_5\1688_单人摇椅_价格排序表_skill_rpa.xlsx。"
)
