...
WRAPPER_TEMPLATE = Template(
    '''"""Ad hoc 1688 marketplace research workflow generated by the app-local builder."""
...
REPO_ROOT = Path(r"$REPO_ROOT_LITERAL")
BASE_SCRIPT_PATH = REPO_ROOT / "apps" / "marketplace_1688_research" / "workflows" / "base_1688_research.py"
MODULE_NAME = "marketplace_1688_app_generated_$MODULE_SUFFIX"
...
base.OUTPUT_DIR = REPO_ROOT / Path(r"$OUTPUT_DIR_LITERAL")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build an app-local ad hoc 1688 marketplace workflow wrapper.")
...
def main() -> int:
    ...
    output_dir = repo_root / "runtime" / "apps" / "marketplace_1688_research" / "reports" / task_name
    workflow_dir = repo_root / "runtime" / "apps" / "marketplace_1688_research" / "generated_workflows" / "marketplaces"
    workflow_dir.mkdir(parents=True, exist_ok=True)
    output_dir.mkdir(parents=True, exist_ok=True)

    workflow_path = workflow_dir / f"{task_name}.py"
    content = WRAPPER_TEMPLATE.substitute(
        REPO_ROOT_LITERAL=str(repo_root),
