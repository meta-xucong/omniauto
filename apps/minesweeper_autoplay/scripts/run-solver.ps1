...
$solver = Join-Path $repoRoot "apps\minesweeper_autoplay\workflows\minesweeper_solver.py"
$closeoutHelper = Join-Path $repoRoot "apps\minesweeper_autoplay\scripts\closeout_solver_run.py"
$artifactsDir = Join-Path $repoRoot "runtime\apps\minesweeper_autoplay\test_artifacts"
...
$env:OMNIAUTO_MINESWEEPER_ARTIFACT_DIR = $artifactsDir
