...
OUTPUT_DIR = Path("runtime/data/reports/1688_single_rocking_chair_5")
...
BROWSER_PROFILE_DIR = os.environ.get("OMNIAUTO_1688_PROFILE_DIR", "runtime/data/chrome_profile_1688").strip() or "runtime/data/chrome_profile_1688"
